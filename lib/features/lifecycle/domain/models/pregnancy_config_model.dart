...
class PregnancyConfigModel {
  ...
  /// Khởi tạo đối tượng từ Map lưu trữ
  ...
  @override
  String toString() {
    return 'PregnancyConfigModel(LMP: $lastMenstrualPeriod, EDD: $estimatedDueDate, conception: $conceptionDate, active: $isTrackingActive)';
  }
}
